...
namespace Zerxz.BetterSeidOptimization.Patch
{
    ...
    {
        [HarmonyPrefix]
        [HarmonyPatch(nameof(Spell.addDBuff), new[] { typeof(int) })]
        ...
        [HarmonyPrefix]
        [HarmonyPatch(nameof(Spell.addDBuff), new[] { typeof(int), typeof(int) })]
        ...
        [HarmonyPrefix]
        [HarmonyPatch(nameof(Spell.addBuff), new[] { typeof(int), typeof(int) })]
