...
namespace Live2D.Cubism.Framework.Json
{
    ...
    public sealed class CubismModel3Json
    {
        ...
        public static CubismModel3Json LoadAtPath(string assetPath, LoadAssetAtPathHandler loadAssetAtPath)
        {
            ...
            // Deserialize Json.
            var modelJson = JObject.Parse(modelJsonAsset).ToObject<CubismModel3Json>();
            if (modelJson == null)
            {
                return null;
            }
        ...
        public byte[] Moc3
        {
            get { return LoadReferencedAsset<byte[]>(FileReferences.Moc); }
        }
        ...
        {
            get { return string.IsNullOrEmpty(FileReferences.Physics) ? null : LoadReferencedAsset<string>(FileReferences.Physics); }
        }

        public string UserData3Json
        {
            get { return string.IsNullOrEmpty(FileReferences.UserData) ? null : LoadReferencedAsset<string>(FileReferences.UserData); }
        }
        ...
        {
            get { return string.IsNullOrEmpty(FileReferences.DisplayInfo) ? null : LoadReferencedAsset<string>(FileReferences.DisplayInfo); }
        }
