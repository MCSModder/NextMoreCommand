...
namespace Live2D.Cubism.Rendering
{
    ...
    public static class CubismBuiltinMaterials
    {
        ...
        {
            return Resources.Load(ResourcesDirectory + "/" + name,typeof(Material)) as Material;
        }
        ...
        {
            return Resources.Load(ResourcesDirectory + "/Mask",typeof(Material)) as Material;
        }
        ...
        {
            return Resources.Load(ResourcesDirectory + "/MaskCulling",typeof(Material)) as Material;
        }
